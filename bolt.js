...
document.body.innerHTML += '<div class="w3-container"><button onclick="()" data-toggle="modal" data-target="#myModal" class="w3-button w3-xlarge w3-circle w3-black">+</button></div>';
