...
function botpop() {
    ...
    $('body').append('<div class="modal fade" id="myModal" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Hai, I am jarvis</h4></div><div class="modal-body"><p>I do nothing</p></div><div class="modal-footer"><button type="button" class="btn btn-default" >Record</button></div></div></div></div></div>');
}
